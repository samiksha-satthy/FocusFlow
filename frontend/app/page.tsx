  ...
  return (
    <main className="pr-[350px] pl-[40px] pr-6 pt-6 h-full">
      ...
      <div className="pb-[4rem] mt-6 grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-2.5">
        ...
        <button className="h-[16rem] w-[280px] py-2 rounded-md text-lg font-medium text-gray-500 border-dashed border-2 border-gray-400 hover:bg-gray-300 hover:border-none transition duration-200 ease-in-out"

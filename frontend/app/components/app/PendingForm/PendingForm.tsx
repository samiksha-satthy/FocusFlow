...
export default function Home() {
  ...
  const { tasks, openModalForAdd, priority, activeTasks, setPriority } = useTasks();

  const filtered = filterTasks(activeTasks, priority);
  ...
  return (
    <main className="pr-[350px] pl-[40px] pr-6 pt-6 h-full">
      <div className="flex items-center gap-186">
